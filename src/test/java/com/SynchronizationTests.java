...
public class SynchronizationTests extends TestCase {
    ...
    // uploads (updates) are successful, you should return status 200. (This means,
    // if a Content Server first connects to the Aggregation Server, then return 201
    ...
    // Your server is designed to stay current and will remove any items in the JSON
