...
// private static final String TEST_FILE_PATH_1 =
// "src/test/resources/test_weather_data_IDS60901.json";
// private static final String TEST_FILE_PATH_2 =
// "src/test/resources/test_weather_data_IDS60902.json";
// private static final String TEST_FILE_PATH_3 =
// "src/test/resources/test_weather_data_IDS60903.txt";

// private ContentServer contentServer;
// private final String aggregationServerUrl = String.format("%s:%s/weather",
// SERVER_URL, AGGREGATION_SERVER_PORT);
// private final String contentServerURL = String.format("%s:%s", SERVER_URL,
// CONTENT_SERVER_PORT); // Added
// // /weather
// // to
